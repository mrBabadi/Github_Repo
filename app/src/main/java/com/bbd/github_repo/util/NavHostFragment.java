...
public class NavHostFragment extends Fragment implements NavHost {
    ...
    protected void onCreateNavController(@NonNull NavController navController) {
        Log.d(TAG, "onCreateNavController: ");
     ...
     * {@link com.bbd.github_repo.util.CustomFragmentNavigator}, which replaces the entire contents of the NavHostFragment.
     * <p>
    ...
    protected Navigator<? extends CustomFragmentNavigator.Destination> createFragmentNavigator() {
        Log.d(TAG, "createFragmentNavigator: ");
