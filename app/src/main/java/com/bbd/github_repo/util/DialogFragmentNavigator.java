...
public final class DialogFragmentNavigator extends Navigator<DialogFragmentNavigator.Destination> {
    ...
    private final LifecycleEventObserver mObserver = new LifecycleEventObserver() {
        @Override
    ...
    public DialogFragmentNavigator(@NonNull Context context, @NonNull FragmentManager manager) {
        Log.d(TAG, "DialogFragmentNavigator: ");
        mContext = context;
    ...
    public static class Destination extends NavDestination implements FloatingWindow {
        private static final String TAG = "DialogFragmentNavigator: Destination";
