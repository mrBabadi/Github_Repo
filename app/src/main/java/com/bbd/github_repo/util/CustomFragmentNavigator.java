...
public class CustomFragmentNavigator extends Navigator<CustomFragmentNavigator.Destination> {
    ...
    public CustomFragmentNavigator(@NonNull Context context, @NonNull FragmentManager manager,
                             int containerId) {
        Log.d(TAG, "CustomFragmentNavigator: ");
        mContext = context;
    ...
    private String generateBackStackName(int backStackIndex, int destId) {
        Log.d(TAG, "generateBackStackName: ");
    ...
    /**
     * NavDestination specific to {@link CustomFragmentNavigator}
     */
    ...
    public static final class Extras implements Navigator.Extras {
        ...
        public static final class Builder {
            private static final String TAG = "FragmentNavigator: Builder";
            private final LinkedHashMap<View, String> mSharedElements = new LinkedHashMap<>();
